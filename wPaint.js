...
(function($)
{
	...
	var shapes = ['Rectangle', 'Ellipse', 'Line', 'Text', 'Fibonacci'];	
	...
	$.fn.wPaint.defaultSettings = {
		...
		fontFamily			 : 'Verdana',			// active font family for text input
		...
		menu 				 : ['undo', 'redo', 'clear','rectangle','ellipse','line','pencil','text','fibonacci','eraser','fillColor','lineWidth','strokeColor'], // menu items - appear in order they are set
	...
	{	
		 ...
		 * draw fibonacci
		 *******************************************************************************/		
		drawFibonacciMove: function(e, _self)
		{
			
			console.log(e.y * 1.25);
			
			_self.ctxTemp.beginPath();
			_self.ctxTemp.fillStyle = "rgba(255, 0, 0, 0.3)";
			_self.ctxTemp.fillRect(e.x, e.y, e.w, e.h * 0.25);
			
			_self.ctxTemp.fillStyle = "rgba(255, 145, 9, 0.3)"
			_self.ctxTemp.fillRect(e.x, e.h * 0.25, e.w, e.h * 0.132);
			
			_self.ctxTemp.fillStyle = "rgba(179, 255, 9, 0.3)";
			_self.ctxTemp.fillRect(e.x, e.h * 0.382, e.w, e.h * 0.118);
			
			_self.ctxTemp.fillStyle = "rgba(9, 255, 13, 0.3)";
			_self.ctxTemp.fillRect(e.x, e.h * 0.5, e.w, e.h * 0.118);
			
			_self.ctxTemp.fillStyle = "rgba(9, 212, 255, 0.3)";
			_self.ctxTemp.fillRect(e.x, e.h * 0.618, e.w, e.h * 0.132);
			
			_self.ctxTemp.fillStyle = "rgba(9, 75, 255, 0.3)";
			_self.ctxTemp.fillRect(e.x, e.h * 0.750, e.w, e.h * 0.25);

			
			
			_self.ctxTemp.lineJoin = "round";
			_self.ctxTemp.beginPath();
			_self.ctxTemp.moveTo(e.x, e.h * 0.25);
			_self.ctxTemp.lineTo(e.x + 80, e.h * 0.25);

			_self.ctxTemp.moveTo(e.x, e.h * 0.382);
			_self.ctxTemp.lineTo(e.x + 80, e.h * 0.382);

			_self.ctxTemp.moveTo(e.x, e.h * 0.5);
			_self.ctxTemp.lineTo(e.x + 80, e.h * 0.5);

			_self.ctxTemp.moveTo(e.x, e.h * 0.618);
			_self.ctxTemp.lineTo(e.x + 80, e.h * 0.618);

			_self.ctxTemp.moveTo(e.x, e.h * 0.75);
			_self.ctxTemp.lineTo(e.x + 80, e.h * 0.75);

			_self.ctxTemp.moveTo(e.x + 10, e.h * 0.75);
			_self.ctxTemp.lineTo(e.x + 10, e.h * 0.75);

			_self.ctxTemp.closePath();
			_self.ctxTemp.lineWidth = 1;
			_self.ctxTemp.stroke();

			_self.ctxTemp.fillStyle = "#000000";
			_self.ctxTemp.font = "14px Verdana";

			_self.ctxTemp.fillText("25%", e.x, e.h * 0.25 - 2);
			_self.ctxTemp.fillText("38.1%", e.x, e.h * 0.382 - 2);
			_self.ctxTemp.fillText("50%", e.x, e.h * 0.5 - 2);
			_self.ctxTemp.fillText("61.8%", e.x, e.h * 0.618 - 2);
			_self.ctxTemp.fillText("75%", e.x, e.h * 0.75 - 2);
	...
	MainMenu.prototype = 
	{
		generate: function(canvas, textMenu)
		{
			...
			var lineWidth = $('<div class="_wPaint_lineWidth _wPaint_dropDown" title="' + $canvas.settings.menuTitles.lineWidth + '"></div>').append(
				$('<select id="OptSize23">' + options + '</select>')
			...
			$.each($canvas.settings.menu, function(i, item)
			{
				switch(item)
				{
					...
					case 'fibonacci': menuContent.append($('<div class="_wPaint_icon _wPaint_fibonacci" title="' + $canvas.settings.menuTitles.fibonacci + '"></div>').click(function(e){ _self.set_mode(_self, $canvas, 'Fibonacci'); })); break;
